/*
  Memory Transfer RA8889

  M Sandercock May 15 2020

  Test memory transfer to send a picture to the RA8889 screen, then use BTE memory copy to move it around
...
void setup() {
  ...
  tft.setFontSize(1, false); // (1) = 12x24 only available internal font size on RA8889.
